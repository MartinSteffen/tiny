package walkimperative

import ("github.com/MartinSteffen/tiny/absynt")


type Visitor interface {
	VisitStmt (absynt.Stmt)             
	VisitExpr (absynt.Expr)             
	VisitSimpleExpr (absynt.SimpleExpr) 
	VisitIdent (absynt.Ident)           
	VisitCompareOp (absynt.CompareOp)   
	VisitTerm (absynt.Term)             
	VisitFactor (absynt.Factor)         
	VisitNumber (absynt.Number)         
	VisitSymbol (absynt.Symbol)         
	VisitAddOp  (absynt.AddOp)          
	VisitMulOp  (absynt.MulOp)          
}
