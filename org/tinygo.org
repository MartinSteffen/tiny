...
****** TODO how does that embedding with register works <2015-08-10 Mon 12:01>
       :PROPERTIES:
       :ID:       6d91e3e7-067b-457b-9319-25405a5af61a
       :END:
...
*** DONE what are the visibility scopes of functions <2015-08-15 Sat 08:10>
    CLOSED: [2015-08-15 Sat 08:14]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-15 Sat 08:14]
    :END:

    Can non-exported functions be seen in the same package? 

    It seems that export is either inside the package or outside, so
    that means probably that functions like builtins are usable within
    the package 
*** DONE why are there no functions exported from builtin.go <2015-08-15 Sat 07:56>
    CLOSED: [2015-08-15 Sat 08:16]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-15 Sat 08:16]
    :END:
    We should see if we can find uses. It could be in call.go

    It seems that export is across packages, inside it's fine.
    
*** DONE make the call.operand more detailed <2015-08-15 Sat 10:51>
    CLOSED: [2015-08-15 Sat 12:02]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-15 Sat 12:02]
    :END:
    actually it's in operand.go? But where is it in call? Or is it?

*** DONE how does expr.internal work <2015-08-15 Sat 12:21>
    CLOSED: [2015-08-15 Sat 12:21]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-15 Sat 12:21]
    :END:
    It seems to be the core of expression cheching
*** DONE what's the mode <2015-08-15 Sat 10:34>
    CLOSED: [2015-08-15 Sat 12:20]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-15 Sat 12:20]
    :END:

    it's part of the operand
*** DONE add expr <2015-08-15 Sat 08:34>
    CLOSED: [2015-08-15 Sat 10:33]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-15 Sat 10:33]
    :END:
*** TODO where are single clauses for real syntax in the type checker? <2015-08-15 Sat 07:45>
    :PROPERTIES:
    :ID:       23bb5769-951d-4624-a465-013528cc6f3f
    :END:
    Maybe in builtins, there should be some
*** TODO what is conf.Check <2015-08-15 Sat 07:27>
    :PROPERTIES:
    :ID:       e3e8074a-8ba7-4798-b3bd-d29374e420da
    :END:
    It's behind api.Check. We have to look into
    api.Config.
*** TODO what is the api.Check <2015-08-15 Sat 07:26>
    :PROPERTIES:
    :ID:       5c4d9017-35f0-479f-ad64-a5f63834bd8a
    :END:
*** TODO what is the data structure(s) the checker works on? <2015-08-15 Sat 07:15>
    :PROPERTIES:
    :ID:       a7f046f3-6a0e-4691-a14c-f3eb5a952e3b
    :END:
*** DONE analyze the check a bit <2015-08-15 Sat 07:04>
    CLOSED: [2015-08-15 Sat 12:57]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-15 Sat 12:57]
    :END:
*** DONE add check <2015-08-15 Sat 06:48>
    ...
    :END:
*** TODO how to implement Type.Typ <2015-08-15 Sat 13:33>
    :PROPERTIES:
    :ID:       54f29454-65eb-4b4a-b534-830e51ee17be
    :END:
    I guess it's rather universe.Typ. there is some use in builder.go.
    In go, the reference (from outside the package) must write type.Typ, in ml
    it's rather Universe.typ
**** DONE do they have enums in ocaml? <2015-08-15 Sat 13:39>
     CLOSED: [2015-08-15 Sat 13:40]
     :LOGBOOK:
     - State "DONE"       from "TODO"       [2015-08-15 Sat 13:40]
     :END:
     Well, just inductive stuff.
**** DONE mappings <2015-08-15 Sat 13:41>
     CLOSED: [2015-08-15 Sat 13:43]
     :LOGBOOK:
     - State "DONE"       from "TODO"       [2015-08-15 Sat 13:43]
     :END:
     So, arrays etc don't work with indices other than
     integers. So, one have the choice either to make the same trick as in the 
     go-compiler (basickind), or make a mapping. Ok, let's do it like that.
**** DONE can one do in ocaml an arrow indexed by some constructed type? <2015-08-15 Sat 13:33>
     CLOSED: [2015-08-15 Sat 13:37]
     :LOGBOOK:
     - State "DONE"       from "TODO"       [2015-08-15 Sat 13:37]
     :END:
     Probably not
...
*** TODO make a stub interface for create <2015-08-11 Tue 08:43>
    :PROPERTIES:
    :ID:       7fe3498b-2363-4111-ab68-f54676921b92
    :END:
    This one is relatively more easy 
*** TODO get the structure of type.type <2015-08-11 Tue 08:26>
    :PROPERTIES:
    :ID:       40d4c03d-36d3-464e-9073-ce75f16a7ec9
    :END:
*** DONE why can one not access o.mode (operand) <2015-08-15 Sat 13:09>
    CLOSED: [2015-08-15 Sat 13:30]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-15 Sat 13:30]
    :END:
    If the do "open Operand" it works
*** TODO add the mode better <2015-08-15 Sat 12:57>
    :PROPERTIES:
    :ID:       e4923e23-83cc-4fe2-ba3f-ff207030f7b8
    :END:
...
*** TODO where do I find stuff like prog.canon <2015-08-13 Thu 08:07>
    :PROPERTIES:
    :ID:       6861b349-7738-4807-80c1-e338c177b351
    :END:
...
*** TODO what's canonization, is it related to type canonization <2015-08-13 Thu 08:09>
    :PROPERTIES:
    :ID:       56262657-bfd2-4d05-8fc7-f506e493733a
    :END:
...
** Typeutil.go 
** Builder.go    
*** DONE how does one define not the keys but the values <2015-08-15 Sat 14:42>
    CLOSED: [2015-08-15 Sat 14:44]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-15 Sat 14:44]
    :END:

    for instance like this


    let x : 'a Typ.t  = Typ.empty;;

*** DONE make the first case distinction. <2015-08-16 Sun 09:10>
    CLOSED: [2015-08-16 Sun 18:20]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 18:20]
    :END:

*** DONE do we have ast already <2015-08-16 Sun 09:11>
    CLOSED: [2015-08-16 Sun 09:40]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 09:40]
    :END:
    yes
*** DONE how can we do the the Order? <2015-08-15 Sat 14:30>
    CLOSED: [2015-08-15 Sat 14:41]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-15 Sat 14:41]
    :END:
*** DONE what the type of typ[Invalid] etc <2015-08-16 Sun 07:22>
    CLOSED: [2015-08-16 Sun 07:28]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 07:28]
    :END:

    It's strange. in operand.go: operand.typ is of type Type. That's
    defined in type.go. Type is an interface. In type.ml the ttype is an
    variant type.  So, we need the constructor Basickind as wrapper, then
    it fits.
*** DONE make the constructors unique <2015-08-16 Sun 07:34>
    CLOSED: [2015-08-16 Sun 08:44]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 08:44]
    :END:
    in type.ml and operand.ml there is constructor Invalid. I currently need
    to open the "Type" and "Operand", but then it's not unique.

    Note: in go, there are the ``constructors'' invalid for the modes
    and Invalid for the types, so there is no confusion there.


*** DONE can one export it with an mli file/interface <2015-08-16 Sun 07:42>
    CLOSED: [2015-08-16 Sun 07:51]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 07:51]
    :END:
    That did not work.
*** DONE what is wrong with the types basic <-> basictype <2015-08-16 Sun 08:14>
    CLOSED: [2015-08-16 Sun 08:43]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 08:43]
    :END:
    The mapping in the universe is a mapping from basictype -> basic, that seems ok.

    
    x.typ = Typ[Invalid]

    Invalid: Basickind (= int)

    Typ: in Universe.go, and it is a mapping, and the result should be Basic.
    That should be the struct in type.go: type Basic struct {
	kind BasicKind
	info BasicInfo
	name string
}
...
so it's a triple.
   ...
   now: x is of type *operand, the field typ is of type "Type" (which is an
   interface is type.go. One element is Basic! Therefore, the type in ml Basic
   is wrong.



*** TODO where is "error" <2015-08-16 Sun 18:21>
    :PROPERTIES:
    :ID:       a5708d55-1247-4b21-a6dd-a35c1555249e
    :END:
*** DONE can one redistribute recursive functions? <2015-08-16 Sun 12:56>
    CLOSED: [2015-08-16 Sun 13:22]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 13:22]
    :END:
    Make a test. Seems to work, would not have expected that.
*** DONE what's check.scope (in types) <2015-08-16 Sun 14:27>
    CLOSED: [2015-08-16 Sun 18:21]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 18:21]
    :END:
    it's used in 	scope, obj := check.scope.LookupParent(e.Name, check.pos)


    check: is something of type *Checker.
*** DONE where's Checker <2015-08-16 Sun 14:32>
    CLOSED: [2015-08-16 Sun 18:20]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 18:20]
    :END:
*** TODO is there a difference between check.scope and environment.scope? <2015-08-16 Sun 14:56>
    :PROPERTIES:
    :ID:       20b3ad87-b773-46c2-858e-7b26de348d65
    :END:
    there is also check.Checker.Scopes
*** DONE analyze 	scope, obj := check.scope.LookupParent(e.Name, check.pos) <2015-08-16 Sun 15:05>
    CLOSED: [2015-08-16 Sun 18:18]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 18:18]
    :END:
    it's in typexpr.go.

    check is of type check.Checker. Strangely, it does not have a field
    scope. There is a record type check.context with that label. There is also a file scope.go. 
    That's for type checking.

**** DONE make a better structure of Check.check <2015-08-16 Sun 16:13>
     CLOSED: [2015-08-16 Sun 18:18]
     :LOGBOOK:
     - State "DONE"       from "TODO"       [2015-08-16 Sun 18:18]
     :END:

**** DONE what's the following field in Checker  <2015-08-16 Sun 17:04>
     CLOSED: [2015-08-16 Sun 17:55]
     :LOGBOOK:
     - State "DONE"       from "TODO"       [2015-08-16 Sun 17:55]
     :END:
...
Info is from api. Seems like an anonymous field.
...
The unqualified type name acts as the field name.  Qualified name is
probably the "*".  Technically, qualified refers to package names.


**** DONE check if there is check.Info <2015-08-16 Sun 17:49
     CLOSED: [2015-08-16 Sun 17:55]
     :LOGBOOK:
     - State "DONE"       from "TODO"       [2015-08-16 Sun 17:55]
     :END:
     yes, in initorder.go for instance

     	check.Info.InitOrder = check.Info.InitOrder[:0]

**** DONE Check LookupParent <2015-08-16 Sun 15:16>
     CLOSED: [2015-08-16 Sun 16:10]
     :LOGBOOK:
     - State "DONE"       from "TODO"       [2015-08-16 Sun 16:10]
     :END:
     It's defined in types/scope.go. It's a method, where the receiver is a scope
**** DONE is the struct Checker extended somehow <2015-08-16 Sun 15:15>
     CLOSED: [2015-08-16 Sun 15:16]
     :LOGBOOK:
     - State "DONE"       from "TODO"       [2015-08-16 Sun 15:16]
     :END:

     Don't find it. But it's like that: the "context" is mixed in.
**** DONE How can we do such an embedding? <2015-08-16 Sun 15:53>
     CLOSED: [2015-08-16 Sun 16:10]
     :LOGBOOK:
     - State "DONE"       from "TODO"       [2015-08-16 Sun 16:10]
     :END:
     There is similar things for register. It's somehow should in principle
     not be hard. The question is more, how can we doing most uniformely
     and most elegantly.

     But the elegance is not too deep. In the thing we are now doing,
     it's like:

        Checker{contex, ...}  That allows for a check: Checker, to access
	fields of context, we can do check.scope. That is shorter than
	check.context.scope, but well. Not much. Let's just make another
	entry. The explicitness is also not too bad.

     
***** DONE have we done it before <2015-08-16 Sun 15:54>
      CLOSED: [2015-08-16 Sun 15:56]
      :LOGBOOK:
      - State "DONE"       from "TODO"       [2015-08-16 Sun 15:56]
      :END:
      No, it was for register, but we have not solved it yet.

*** DONE is assert builtin into go? <2015-08-16 Sun 14:59>
    CLOSED: [2015-08-16 Sun 15:00]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 15:00]
    :END:
    seems like, some instances. leads to panic
*** DONE do they have assert in ocaml <2015-08-16 Sun 15:00>
    CLOSED: [2015-08-16 Sun 15:01]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 15:01]
    :END:
    yep
*** DONE check_ident <2015-08-16 Sun 12:25>
    CLOSED: [2015-08-16 Sun 18:20]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 18:20]
    :END:
*** DONE how do we do a type switch in ocaml <2015-08-16 Sun 11:28>
    CLOSED: [2015-08-16 Sun 12:25]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 12:25]
    :END:
    That is done here in exprinternal, 

    e:= e.(type)

    e must be an interface. There, the interface is ast.Expr.

    The case switch is according to the types (structs) that implements
    that interface. Here, it's done better. We don't need a case switch, we
    just switiching

    Then the question is what's the e left of the :=

    Well, in the switch case, for instance of identifiers:
    case.ast.Ident. That's a struct.  

    It seems that basically the two e's above are the same, but
    in the second case, it's the struct, so in a way it works 
    as a type case.

*** DONE what e.(type) and e:= e.(type) <2015-08-16 Sun 11:09>
    CLOSED: [2015-08-16 Sun 11:27]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 11:27]
    :END:
    It's in expr.go

    It's a type assertion. It's often used in a case switch, a type switch.
*** DONE add exceptions <2015-08-16 Sun 10:50>
    CLOSED: [2015-08-16 Sun 11:09]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 11:09]
    :END:
*** DONE probably we need to restructure the thing <2015-08-16 Sun 10:21>
    CLOSED: [2015-08-16 Sun 10:22]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 10:22]
    :END:
*** TODO what's the goto Error doing in expr.go <2015-08-16 Sun 09:49>
    :PROPERTIES:
    :ID:       25c71c4e-eca0-40e3-9cc6-4c1aac8e2e72
    :END:
*** DONE what's the pattern types.Typ[types.Bool] <2015-08-13 Thu 11:19>
    CLOSED: [2015-08-16 Sun 08:44]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2015-08-16 Sun 08:44]
    :END:
    
    the "types" refers to the package, not the file. Typ is in types/Universe.go
...
*** TODO what are anonymous fields <2015-08-13 Thu 11:38>
    :PROPERTIES:
    :ID:       e870ffff-48d2-4691-9ff3-5ff3202a02af
    :END:
