...
sense it's not clear if that is officially a visitor. One ingredient seems
missing, at least if one compares it to the visitor pattern as known,
...
*** TODO [#A]  add recursion <2015-07-18 Sat 17:41>
