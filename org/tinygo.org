...
**** TODO check perhaps the printer test code <2015-07-28 Tue 12:05>
...
**** TODO what's the type of the ~idents~ function here? <2015-07-28 Tue 12:14>

The ``type' seems to be ~(f *ast.File) <-chan *ast.Ident~. That's the
/signature/. I would guess that ~*ast.File~ is the /parameters/ and the
rest ~<-chan *ast.Ident~ is the /result/.


*** TODO adapt the test directory accordingly <2015-07-28 Tue 10:55>
