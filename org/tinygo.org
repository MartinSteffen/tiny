...
****** TODO check the various types <2015-08-08 Sat 14:47>
       :PROPERTIES:
       ...
       Node: String Pos Parent [Operands] [Referrers]
        ...
        |                 | Node |   | Name | Str | Pos | Par | Ops | Refs | Block | setBlock | Type | Val | Common | Descr | sig | staticallee | isinvoke | Object | Token | Pack | Rstr   | stype   | snum   | spos   | Func | Var |       |
        |-----------------+------+---+------+-----+-----+-----+-----+------+-------+----------+------+-----+--------+-------+-----+-------------+----------+--------+-------+------+--------+---------+--------+--------+------+-----+-------|
        | Node            |      |   |      | x   | x   | x   | [x] | [x]  |       |          |      |     |        |       |     |             |          |        |       |      |        |         |        |        |      |     |       |
        | Instruction     |      |   |      | x   | x   | x   | x   |      | x     | x        |      |     |        |       |     |             |          |        |       |      |        |         |        |        |      |     |       |
        | Value           |      |   | x    | x   | x   | x   |     | x    |       |          | x    |     |        |       |     |             |          |        |       |      |        |         |        |        |      |     |       |
        | CallInstruction |      |   |      |     |     |     |     |      |       |          |      | val | common |       |     |             |          |        |       |      |        |         |        |        |      |     |       |
        |-----------------+------+---+------+-----+-----+-----+-----+------+-------+----------+------+-----+--------+-------+-----+-------------+----------+--------+-------+------+--------+---------+--------+--------+------+-----+-------|
        | Program         | -    |   |      |     |     |     |     |      |       |          |      |     |        |       |     |             |          |        |       |      |        |         |        |        |      |     |       |
        ...
        |-----------------+------+---+------+-----+-----+-----+-----+------+-------+----------+------+-----+--------+-------+-----+-------------+----------+--------+-------+------+--------+---------+--------+--------+------+-----+-------|
        | Function        |      |   | name | str | pos | par |     | refs |       |          | type |     |        |       |     |             |          | object | token | pack |        |         |        |        |      |     |       |
        | BasicBlock      |      |   |      |     |     |     |     |      |       |          |      |     |        |       |     |             |          |        |       |      |        |         |        |        |      |     |       |
        | FreeVar         |      |   | name |     | pos | par |     | refs |       |          | type |     |        |       |     |             |          |        |       |      |        |         |        |        |      |     |       |
        | Parameter       |      |   | name |     | pos | par |     | refs |       |          | type |     |        |       |     |             |          | object |       |      |        |         |        |        |      |     |       |
        | Const           |      |   |      |     |     |     |     |      |       |          |      |     |        |       |     |             |          |        |       |      |        |         |        |        |      |     |       |
        | Global          |      |   | name | str | pos | par |     | refs |       |          | type |     |        |       |     |             |          | object | token | pack | relstr |         |        |        |      |     |       |
        | Builtin         |      |   | name |     | pos | par |     | refs |       |          | type |     |        |       |     |             |          | object |       |      |        |         |        |        |      |     |       |
        | Alloc           |      |   |      |     | pos |     |     | refs |       |          | type |     |        |       |     |             |          |        |       |      |        |         |        |        |      |     |       |
        | Phi             |      |   |      |     |     |     |     |      |       |          |      |     |        |       |     |             |          |        |       |      |        |         |        |        |      |     |       |
        | Call            |      |   |      |     |     |     |     |      |       |          |      | val | common |       |     |             |          |        |       |      |        |         |        |        |      |     |       |
        | BinOp           |      |   |      |     |     |     |     |      |       |          |      |     |        |       |     |             |          |        |       |      |        |         |        |        |      |     |       |
...
---------------------
	...
	Referrers() *[]Instruction   +-     NOPE // nil for non-Values
}
