...
****** TODO check the various types <2015-08-08 Sat 14:47>
       ...
       Node: String Pos Parent [Operands] [Referrers]
        ...
        |                 | Node |   | Name | String | Pos | Parent | Ops | Refs | Block | setBlock | Type | Value | Common | Descr | sig | staticallee | isinvoke |
        |-----------------+------+---+------+--------+-----+--------+-----+------+-------+----------+------+-------+--------+-------+-----+-------------+----------|
        | Node            |      |   |      | x      | x   | x      | [x] | [x]  |       |          |      |       |        |       |     |             |          |
        | Instruction     |      |   |      | x      | x   | x      | x   |      | x     | x        |      |       |        |       |     |             |          |
        | Value           |      |   | x    | x      | x   | x      |     | x    |       |          | x    |       |        |       |     |             |          |
        | CallInstruction |      |   |      |        |     |        |     |      |       |          |      | value | common |       |     |             |          |
        |-----------------+------+---+------+--------+-----+--------+-----+------+-------+----------+------+-------+--------+-------+-----+-------------+----------|
        | Program         | -    |   |      |        |     |        |     |      |       |          |      |       |        |       |     |             |          |
        | Package         | -    |   |      |        |     |        |     |      |       |          |      |       |        |       |     |             |          |
        | Type            | -    |   |      |        |     |        |     |      |       |          |      |       |        |       |     |             |          |
